...
.button {
  ...
  cursor: pointer;
    ...
    <div class="site-section">
        <div class="container">
            <form name="abc" method="post" action="contactuserend"  onsubmit="return validate()">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <input type="submit" value="Send Message" class="btn btn-primary btn-lg px-5" onsubmit="return validate()">
                </div>
            </div>
                       </form>
            <script>
...
function validate() {
  ...
  var x = document.forms["abc"]["eaddress"].value;
    var x1 = document.forms["abc"]["tel"].value;
  var x2 = document.forms["abc"]["message"].value;
    var x3 = document.forms["abc"]["fname"].value;
  var x4 = document.forms["abc"]["lname"].value;
   // alert("test"+x+x2+x1);
  ...
  if (x3 == ""&&x4=="") {
   ...
   if (x1== "") {
    alert("Please add the email address for contact");
    return false;
  }
   if (x2 == "") {
