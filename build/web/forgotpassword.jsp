...
if (password == "") {
  ...
  <form name="myForm" action="forgotpass" method="post" onsubmit="return validateForm()">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="username">Enter registered username</label>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="pword2" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
