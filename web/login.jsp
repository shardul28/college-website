...
.button {
  ...
  <form name="myForm" action="login1" method="get">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                  
                        <div class="col-md-12 form-group">
                            <label for="username">Enter Student ID/Teacher ID/Staff ID</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <input type="submit" value="Log In" class="btn btn-primary btn-lg px-5">
                                 <a href="forgotpassword.jsp" class="small mr-3"></span> forgot password</a> 
